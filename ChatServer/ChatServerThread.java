...
public class ChatServerThread extends Thread {
    ...
    private static List<ChatServerThread> threads = new ArrayList<ChatServerThread>(); //スレッドの集合
	...
	try {
	    //ストリーム
	    System.out.println("ChatServerThread started");
		...
		try {
		    ...
		    System.out.println("ChatServerThread stoped");
		    socket.close();
		    threads.remove(this);
		    return;
		}
